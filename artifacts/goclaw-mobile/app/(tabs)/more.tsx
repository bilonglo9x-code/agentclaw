...
const SECTIONS: MenuSection[] = [
  ...
  },
  {
    title: "Dữ liệu",
    items: [
      { icon: "brain-outline" as any, label: "Memory & Knowledge", color: "#f97316" },
  ...
  },
  {
    ...
    tag: "Owner only",
    items: [
      { icon: "color-palette-outline", label: "Branding & Theme", color: "#f97316" },
      { icon: "business-outline", label: "Tenants", badge: "3", color: "#60a5fa" },
      { icon: "settings-outline", label: "Providers & Config", color: "#a78bfa" },
      { icon: "key-outline", label: "API Keys", badge: "5", color: "#f59e0b" },
      { icon: "swap-horizontal-outline", label: "Import / Export", color: "#22c55e" },
    ],
  },
  {
    title: "Tài khoản",
    items: [
      ...
      { icon: "log-out-outline", label: "Đăng xuất", danger: true },
    ],
  },
];
    ...
    >
      ...
      <View style={[styles.profile, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <View style={styles.profileInfo}>
          <Text style={[styles.profileName, { color: colors.foreground }]}>Admin User</Text>
          <Text style={[styles.profileEmail, { color: colors.mutedForeground }]}>admin@goclaw.dev</Text>
          <View style={styles.profileBadgeRow}>
            <View style={[styles.ownerBadge, { backgroundColor: colors.primary + "20", borderColor: colors.primary + "40" }]}>
              <Text style={[styles.ownerText, { color: colors.primary }]}>Owner</Text>
            </View>
            <Text style={[styles.orgText, { color: colors.mutedForeground }]}>Acme Corp</Text>
          </View>
        </View>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  ownerBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, borderWidth: 1 },
  ownerText: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
  orgText: { fontSize: 11, fontFamily: "Inter_400Regular" },
